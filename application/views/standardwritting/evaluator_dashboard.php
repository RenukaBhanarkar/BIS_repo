    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">
                <?php
                if (encryptids("D", $_SESSION['admin_type']) == 1) { ?> Super Admin Dashboard <?php } else  if (encryptids("D", $_SESSION['admin_type']) == 2) { ?> StandardWriting Dashboard <?php } else { ?> Sub Admin Dashboard<?php } ?></h1>
        ...
        <div class="row mt-3 ">
            ...
            <?php //if (encryptids("D", $_SESSION['admin_type']) == 1 || encryptids("D", $_SESSION['admin_type']) == 2) { ?>
                ...
                <div class="col-xl-3 col-md-6 mb-4">
                    <a href="<?php echo base_url(); ?>Standardswritting/task_recevied_list">
                ...
                <div class="col-xl-3 col-md-6 mb-4">
                    <a href="<?php echo base_url(); ?>Standardswritting/task_reviewed">
                        <div class="card border-left-primary shadow h-100 py-2">
                            <div class="card-body">
                                <div class="row no-gutters align-items-center d-flex">
