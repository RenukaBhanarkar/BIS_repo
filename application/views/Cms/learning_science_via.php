...
<div class="modal fade" id="add_new" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      ...
      <form id="add_admin" class="was-validated"  action="<?php echo base_url(); ?>cms/add_learning_science_via" method="post" enctype="multipart/form-data">
...
<div class="modal fade" id="edit_form" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"> Edit Learning Science via Standards</h5>
        <button class="close" type="button" data-bs-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
      </div>
      
      <form action="<?php echo base_url().'cms/update_learning_science_via'; ?>" id="update_ban" class="was-validated" method="post" enctype="multipart/form-data" >
      <div class="modal-body">
      <!-- <div class="row">
                <div class="mb-2 col-md-4">
    ...
    $('#example').on('click','.delete_img',function(){
        ...
        Swal.fire({
                    ...
                    if (result.isConfirmed) {   
                        $.ajax({
                             type: 'POST',
                            url: '<?php echo base_url(); ?>cms/delet_learning_science_via',
                            data: {
                                que_id: id,
                                banner:image,
                            },
