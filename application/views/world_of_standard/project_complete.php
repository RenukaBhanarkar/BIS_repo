...
<div class="col-12 mt-1">
  				<div class="breadcrums">
  					<ul>
                        ...
                        <li><a class="active">Projects Completed</a></li>
    ...
    <div class="col-sx-12 col-sm-12 col-md-12" style="border-left: 3px solid cadetblue; padding: 0px 25px;">
        <div class="static-content">
            <div class="bloginfo">
                <h3 style="margin-bottom: 0px;margin-top:20px;color: #0086b2!important;font-weight: 600;">Projects Completed</h3>
            </div>
  ...
  <script>
    ...
    Swal.fire({
                    ...
                    if (result.isConfirmed) {    
                        window.location.replace('<?php echo base_url().'world_of_standard/project_complete_list'?>');                   
