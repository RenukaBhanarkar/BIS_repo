          ...
          <div class="card-body">
            ...
            <div class="row mt-2">
              ...
              <div class="mb-2 col-md-4">
                ...
                <input type="text" class="form-control input-font" name="fdetails" id="fdetails" placeholder="Enter Details" value="<?php if (!empty($firstprize['prize_details'])) {
              ...
              <div class="mb-2 col-md-4">
                ...
                <?php if (!empty($firstprize['prize_img'])) {  ?>
                  ...
                  <input type="hidden" id="fp_img"  name="fp_img" value="0">
                ...
                <?php } else { ?>
                  <div class="row" id="add_file1">
                    <div class="col-12">
                    <input type="hidden" id="fp_img"  name="fp_img" value="1">
            ...
            <div class="row mt-2">
              ...
              <div class="mb-2 col-md-4">
                ...
                <?php if (!empty($secondprize['prize_img'])) {  ?>
                  ...
                  <input type="hidden" id="sp_img"  name="sp_img" value="0">
                ...
                <?php } else { ?>
                  <div class="row" id="add_file2">
                    <div class="col-12">
                    <input type="hidden" id="sp_img"  name="sp_img" value="1">
            ...
            <div class="row mt-2">
              ...
              <div class="mb-2 col-md-4">
                ...
                <?php if (!empty($thirdprize['prize_img'])) {  ?>
                  ...
                  <input type="hidden" id="tp_img"  name="tp_img" value="0">
                ...
                <?php } else { ?>
                  <div class="row" id="add_file3">
                    <div class="col-12">
                    <input type="hidden" id="tp_img"  name="tp_img" value="1">
            ...
            <div class="row mt-2">
              ...
              <div class="mb-2 col-md-4">
                ...
                <?php if (!empty($fourthprize['no_of_prize'])) {  ?>
                  ...
                  <input type="hidden" id="cp_img"  name="cp_img" value="0">
                ...
                <?php } else { ?>
                  <div class="row" id="add_file4">
                    <div class="col-12">
                    <input type="hidden" id="cp_img"  name="cp_img" value="1">
