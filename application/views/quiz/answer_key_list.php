                            ...
                            <div class="mb-2 col-md-12">
                                ...
                                <div>
                                    ...
                                    <ol>
                                        ...
                                        echo "class='green mt-2'"; 
                                    } ?>
                                    
                                    <?php if (($row['corr_opt_e'] == $row['selected_op']) && ($row['corr_opt_e'] == 1) )    {                                               
                                                echo "class='green mt-2 ' ";
                                              
                                            } if (($row['corr_opt_e'] != $row['selected_op']) && ($row['selected_op'] == 1)) { echo "class='red mt-2'"; } ?>> <?php echo  $option1; ?>
                                              <!-- <div class='correct_answer'>Correct Answer</div>
                                               
                                              <div class="incorrect_answer">Incorrect Answer</div> -->
                                    ...
                                    <?php if (($row['corr_opt_e'] == $row['selected_op']) && ($row['corr_opt_e'] == 2) ){                                               
                                                echo "class='green mt-2'";
                                            } if (($row['corr_opt_e'] != $row['selected_op']) && ($row['selected_op'] == 2)) { echo "class='red mt-2'"; } ?>> <?php echo  $option2; ?>
                                        </li>
                                    ...
                                    <?php if (($row['corr_opt_e'] == $row['selected_op']) && ($row['corr_opt_e'] == 3) ){                                               
                                                echo "class='green mt-2'";
                                            }  if (($row['corr_opt_e'] != $row['selected_op']) && ($row['selected_op'] == 3)) { echo "class='red mt-2'"; } ?>> <?php echo  $option3; ?>
                                        </li>
                                    ...
                                    <?php if (($row['corr_opt_e'] == $row['selected_op']) && ($row['corr_opt_e'] == 4) ){                                               
                                                echo "class='green mt-2'";
                                            } if (($row['corr_opt_e'] != $row['selected_op']) && ($row['selected_op'] == 4)) { echo "class='red mt-2'"; } ?>> <?php echo  $option4; ?>
                                        </li>
                                    ...
                                    <?php if (($row['corr_opt_e'] == $row['selected_op']) && ($row['corr_opt_e'] == 5) ){                                               
                                                echo "class='green mt-2'";
                                            }  if (($row['corr_opt_e'] != $row['selected_op']) && ($row['selected_op'] == 5)) { echo "class='red mt-2'"; } ?>> <?php echo  $option5; ?>
                                        </li>
