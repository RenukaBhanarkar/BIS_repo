...
<div id="privacy-content" class="container">
    <div class="col-sx-12 col-sm-12 col-md-12" style="border-left: 3px solid cadetblue; padding: 0px 25px;">
        <div class="static-content">
            <div class="bloginfo">
                <h3 style="margin-bottom: 0px;margin-top:20px;color: #0086b2!important;font-weight: 600;">Learning Science via Standards</h3>
            </div>
    ...
    <div class="col-md-12">
            ...
            <?php if(!empty($Learning_via_standards)){ ?>
            <p style="text-align: justify;">
            <?php echo $Learning_via_standards[0]['description']; ?>
             </p>
             <?php } ?>
            </div>
