...
<div id="privacy-content" class="container">
    <div class="col-sx-12 col-sm-12 col-md-12" style="border-left: 3px solid cadetblue; padding: 0px 25px;">
        <div class="static-content">
            <div class="bloginfo">
                <h3 style="margin-bottom: 0px;margin-top:20px;color: #0086b2!important;font-weight: 600;">About Manak Rath</h3>
            </div>
    ...
    <div class="row">
            <div class="col-md-12">
            <img src="<?php echo base_url().'uploads/cms/about_exchange_forum/'.$about_exchange_forum['image']; ?>" id="about_new">
