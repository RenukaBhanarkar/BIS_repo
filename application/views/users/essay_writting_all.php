...
<div class="col-sx-12 col-sm-12 col-md-12" style="border-left: 3px solid cadetblue; padding: 0px 25px;">
        <div class="static-content">
            <div class="bloginfo">
                <h3 style="margin-bottom: 0px;margin-top:20px;color: #0086b2!important;font-weight: 600;">Essay Writting</h3>
            </div>
            ...
            <div class="row">
              <div class="col-md-3">
                <div class="card-winners">
                    <img src="#" style="height: 176px;">
                    <div class="winner-body p-2">
                    <div class="title">
                            <a href="#" title="Inviting suggestion on Vivad se Vishwas II – Settling Contractual ...">Inviting suggestion on Vivad se Vishwas</a>
                        </div>
                            <div class="quiz-period">
                                <div class="start-time"><span>From :</span>Jun 12 2023</div>
                                <div class="end-time"><span>To :</span>Jun 20 2023</div>
                            </div>
                            <div class="ques-block">
                              <div class="question_detail">
                                
                              </div>
                              <a href="#" class="quizplay-btn">Participate</a>
