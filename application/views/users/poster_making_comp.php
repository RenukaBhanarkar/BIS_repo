...
<section>
        <div class="container pb-5 pt-5" id="winner-section">
            ...
            <div class="row">
                <?php  foreach ($poster_making as $key => $AllQuize) {?> 
               
              <div class="col-md-3">
                <div class="card-winners">
                    <img src="<?php echo base_url(); ?><?= $AllQuize['thumbnail']?>" style="height: 176px;">
                    <div class="winner-body p-2">
                    <div class="title">
                            <a href="about_quiz/<?= $AllQuize['id']?>" title="Inviting suggestion on Vivad se Vishwas II – Settling Contractual ..."><?= $AllQuize['competiton_name']?></a>
                        </div>
                            ...
                            <div class="ques-block">
                              ...
                              <a href="<?php echo base_url().'users/about_competition/'.$AllQuize['comp_id']?>" class="quizplay-btn">Participate</a>
                                                              
                            </div>
                            <div class="item_foo">
                                <!-- <a href="javascript:void(0)" class="get_reward"><i> </i> E-Certificate</a> -->
                                <a href="<?= base_url(); ?>users/about_competition/<?php echo $AllQuize['comp_id']; ?>" class="view_tc">View T&amp;C</a>
                            </div>
                    </div>
                </div>
              </div> 
