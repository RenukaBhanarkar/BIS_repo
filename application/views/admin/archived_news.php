...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Archived News</h1>
  ...
  <div class="row">
        <div class="col-12">
            <div class="card border-top card-body">
                <div>
                    <a href="<?php echo base_url().'/admin/letest_news' ?>" type="button" class="btn btn-primary btn-sm mr-2" >Letest News</a>
                </div>
    ...
    $('#example').on('click','.restore',function(){
        ...
        Swal.fire({
                    ...
                    if (result.isConfirmed) {   
                        $.ajax({
                             type: 'POST',
                            url: '<?php echo base_url(); ?>admin/restoreLetestNews/'+id,
                            // data: {
                            //     que_id: id,
                            // },
