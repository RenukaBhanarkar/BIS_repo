                                            ...
                                            if(!empty($PartiallyAppearedNotOut)){
                                               ...
                                               // echo "user_quiz_start_time ".$user_quiz_start_time.'<br>';
                                                ...
                                                if( $duration_sec != 0){
                                                    ...
                                                    $this->session->set_flashdata('MSG', ShowAlert("11111.You have already appeared for this quiz and quiz time is over.Please try another quiz.", "DD"));
                                                    redirect(base_url() . "users/about_quiz/$quiz_id", 'refresh');
                                                }
                                           
                                            }else{
                                                $this->session->set_flashdata('MSG', ShowAlert("222222.You can not appear this quiz  as your quiz time is over.Please try another quiz.", "DD"));
                                                    redirect(base_url() . "users/about_quiz/$quiz_id", 'refresh');
                                            }
                                        }else{
                                            // first time
